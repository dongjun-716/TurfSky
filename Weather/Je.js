...
export default function Je({ navigation}) {
  const [locations, setLocations] = useState([
    { name: '중문해변', latitude: 33.24, longitude: 126.41 },
    { name: '이호테우해변', latitude: 33.49, longitude: 126.45 },
    { name: '월정해변', latitude: 33.55, longitude: 126.79 },
    { name: '사계해변', latitude: 33.22, longitude: 126.30 },
  ]);
