...
export default function Pu({navigation}) {
  const [locations, setLocations] = useState([
    { name: '송정해변', latitude: 35.17, longitude: 129.19 },
    { name: '다대포해변', latitude: 35.04, longitude: 128.96 },
    { name: '광안리해변', latitude: 35.15, longitude: 129.11 },
  ]);
