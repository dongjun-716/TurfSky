...
export default function Yang({navigation}) {
  const [locations, setLocations] = useState([
    { name: '죽도해변', latitude: 37.97, longitude: 128.76 },
    { name: '인구해변', latitude: 37.96, longitude: 128.76 },
    { name: '기사문해변', latitude: 38.00, longitude: 128.73 },
    { name: '갯마을 해변', latitude: 37.94, longitude: 128.77 },
    { name: '물치해변', latitude: 38.15, longitude: 128.61 },
    { name: '설악해변', latitude: 38.12, longitude: 128.62 },
    { name: '동산해변', latitude: 37.98, longitude: 128.75 },
    { name: '하조대해변', latitude: 38.02, longitude: 128.72 },
    { name: '낙산해변', latitude: 38.11, longitude: 128.63 },
    { name: '정암해변', latitude: 38.13, longitude: 128.61 },
  ]);
